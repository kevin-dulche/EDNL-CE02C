...
public abstract class AbstractBinarySearchTree {
    ...
    // En la clase AbstractBinarySearchTree o en sus clases hijas, como AVLTree y RedBlackTree

    /**
     * Busca un elemento en el árbol.
     * 
     * @param element El elemento a buscar.
     * @return True si el elemento está presente en el árbol, de lo contrario, False.
     */
    public boolean busqueda(int element) {
        return busquedaRec(root, element);
    }

    /**
     * Método de búsqueda auxiliar recursivo.
     * 
     * @param node    El nodo desde el cual comenzar la búsqueda.
     * @param element El elemento a buscar.
     * @return True si el elemento está presente en el árbol, de lo contrario, False.
     */
    private boolean busquedaRec(Node node, int element) {
        if (node == null) {
            return false;
        }
        if (node.value == element) {
            ...
            return busquedaRec(node.left, element);
        } else {
            return busquedaRec(node.right, element);
        }
    }
}